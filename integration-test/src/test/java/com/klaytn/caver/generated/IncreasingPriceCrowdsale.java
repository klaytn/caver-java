 ...
 */
public class IncreasingPriceCrowdsale extends SmartContract {
    ...
    protected IncreasingPriceCrowdsale(String contractAddress, Caver caver, KlayCredentials credentials, int chainId, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, caver, credentials, chainId, contractGasProvider);
    }

    protected IncreasingPriceCrowdsale(String contractAddress, Caver caver, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static IncreasingPriceCrowdsale load(String contractAddress, Caver caver, KlayCredentials credentials, int chainId, ContractGasProvider contractGasProvider) {
        return new IncreasingPriceCrowdsale(contractAddress, caver, credentials, chainId, contractGasProvider);
    }

    public static IncreasingPriceCrowdsale load(String contractAddress, Caver caver, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IncreasingPriceCrowdsale(contractAddress, caver, transactionManager, contractGasProvider);
    }

    public static RemoteCall<IncreasingPriceCrowdsale> deploy(Caver caver, KlayCredentials credentials, int chainId, ContractGasProvider contractGasProvider, BigInteger initialRate, BigInteger finalRate) {
        ...
        return deployRemoteCall(IncreasingPriceCrowdsale.class, caver, credentials, chainId, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<IncreasingPriceCrowdsale> deploy(Caver caver, TransactionManager transactionManager, ContractGasProvider contractGasProvider, BigInteger initialRate, BigInteger finalRate) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(initialRate), 
                new org.web3j.abi.datatypes.generated.Uint256(finalRate)));
        return deployRemoteCall(IncreasingPriceCrowdsale.class, caver, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }
