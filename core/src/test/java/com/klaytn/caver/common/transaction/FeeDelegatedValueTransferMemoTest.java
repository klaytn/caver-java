...
public class FeeDelegatedValueTransferMemoTest {
    ...
    public static class createInstance {
        ...
        public void createInstance() {
            FeeDelegatedValueTransferMemo txObj = new FeeDelegatedValueTransferMemo(
                    null,
                    from,
                    nonce,
                    gas,
    ...
    public static class signAsFeePayer_OneKeyTest {
        ...
        @Before
        public void before() {
            txObj = new FeeDelegatedValueTransferMemo.Builder()
                    .setNonce(nonce)
                    .setGas(gas)
                    .setGasPrice(gasPrice)
                    .setTo(to)
    ...
    public static class signAsFeePayer_AllKeyTest {
        ...
        @Before
        public void before() {
            mTxObj = new FeeDelegatedValueTransferMemo.Builder()
                    .setNonce(nonce)
                    .setGas(gas)
                    .setGasPrice(gasPrice)
                    .setTo(to)
    ...
    public static class combineSignatureTest {
        ...
        public void combineSignature() {
            ...
            String rlpEncoded = "";
        ...
        public void combine_multipleSignature() {
            ...
            String expectedRLPEncoded = "";
    ...
    public static class getRawTransactionTest {
        ...
        public void getRawTransaction() {
            FeeDelegatedValueTransferMemo mTxObj = new FeeDelegatedValueTransferMemo.Builder()
                    .setNonce(nonce)
                    .setGas(gas)
                    .setGasPrice(gasPrice)
                    .setTo(to)
