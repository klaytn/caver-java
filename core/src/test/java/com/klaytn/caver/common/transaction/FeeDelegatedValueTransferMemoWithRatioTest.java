...
public class FeeDelegatedValueTransferMemoWithRatioTest {
    ...
    public static class createInstanceBuilder {
        ...
        public void BuilderTest() {
            ...
            assertEquals(TransactionType.TxTypeFeeDelegatedValueTransferMemoWithRatio.toString(), feeDelegatedValueTransferMemoWithRatio.getType());
        }
    ...
    public static class createInstance {
        ...
        public void createInstance() {
            ...
            assertNotNull(txObj);
            assertEquals(TransactionType.TxTypeFeeDelegatedValueTransferMemoWithRatio.toString(), txObj.getType());
        }
