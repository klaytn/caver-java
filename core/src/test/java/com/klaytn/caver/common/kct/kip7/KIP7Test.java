package com.klaytn.caver.common.kct.kip7;
...
public class KIP7Test {
    ...
    public static class ConstructorTest {
        ...
        public void deploy() throws Exception {
            Caver caver = new Caver(Caver.DEFAULT_URL);
            caver.wallet.add(caver.wallet.keyring.createFromPrivateKey("0x2359d1ae7317c01532a58b01452476b796a3ac713336e97d8d3c9651cc0aecc3"));
            KIP7 contract = caver.kct.kip7.deploy(LUMAN.getAddress(), CONTRACT_NAME, CONTRACT_SYMBOL, CONTRACT_DECIMALS, CONTRACT_INITIAL_SUPPLY);
    ...
    public static class DetectInterfaceTest {
        ...
        public void detectInterface_staticMethod() {
            Map<String, Boolean> result = caver.kct.kip7.detectInterface(kip7contract.getContractAddress());
            assertTrue(result.get(KIP7.INTERFACE.IKIP7.getName()));
            assertTrue(result.get(KIP7.INTERFACE.IKIP7_BURNABLE.getName()));
            assertTrue(result.get(KIP7.INTERFACE.IKIP7_METADATA.getName()));
            assertTrue(result.get(KIP7.INTERFACE.IKIP7_MINTABLE.getName()));
        ...
        public void only_mintable() throws IOException, NoSuchMethodException, InstantiationException, ClassNotFoundException, IllegalAccessException, InvocationTargetException, TransactionException {
            ...
            Map<String, Boolean> result = caver.kct.kip7.detectInterface(contract.getContractAddress());
            assertTrue(result.get(KIP7.INTERFACE.IKIP7.getName()));
    ...
    public static class FeeDelegationTest {
        ...
        public static void init() throws TransactionException, IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            KIP7 kip7 = caver.kct.kip7.deploy(kip7DeployParam, sender);
            contractAddress = kip7.getContractAddress();
        }
        ...
        public void deploy() throws TransactionException, IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            KIP7 kip7 = caver.kct.kip7.deploy(sendOptions, CONTRACT_NAME, CONTRACT_SYMBOL, CONTRACT_DECIMALS, CONTRACT_INITIAL_SUPPLY);
            assertNotNull(kip7.getContractAddress());
        }
        ...
        public void addMinter_FD() throws IOException, TransactionException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            TransactionReceipt.TransactionReceiptData receiptData = kip7.addMinter(caver.wallet.keyring.generate().getAddress(), sendOptions);
        ...
        public void addMinter_defaultOptions_FDWithRatio() throws IOException, TransactionException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            KIP7 kip7 = caver.kct.kip7.create(contractAddress);
            kip7.setDefaultSendOptions(defaultSendOptions);

            TransactionReceipt.TransactionReceiptData receiptData = kip7.addMinter(caver.wallet.keyring.generate().getAddress());
        ...
        public void addMinter_overwrite_defaultOptions_FDWithRatio() throws IOException, TransactionException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            KIP7 kip7 = caver.kct.kip7.create(contractAddress);
            kip7.setDefaultSendOptions(defaultOptions);
            ...
            TransactionReceipt.TransactionReceiptData receiptData = kip7.addMinter(caver.wallet.keyring.generate().getAddress(), options);
        ...
        public void sign_constructor() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, TransactionException {
            ...
            AbstractFeeDelegatedTransaction signed = (AbstractFeeDelegatedTransaction)kip7.sign(options, "constructor", KIP7ConstantData.BINARY, CONTRACT_NAME, CONTRACT_SYMBOL, CONTRACT_DECIMALS, CONTRACT_INITIAL_SUPPLY);
        ...
        public void sign_addMinter() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, TransactionException {
            ...
            AbstractFeeDelegatedTransaction signed = (AbstractFeeDelegatedTransaction)kip7.sign(options, "addMinter", caver.wallet.keyring.generate().getAddress());
        ...
        public void signAsFeePayer_addMinter() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, TransactionException {
            ...
            AbstractFeeDelegatedTransaction signed = kip7.signAsFeePayer(options, "addMinter", caver.wallet.keyring.generate().getAddress());
    ...
    public static class decodeFunctionCall {
        ...
        public void decodeFunctionCall() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            String encoded = kip7.encodeABI("pause");
            List<Type> actual = kip7.decodeFunctionCall(encoded);
            checkTypeAndValue(expected, actual);

            expected = Arrays.asList(LUMAN.getAddress());
            encoded = kip7.encodeABI("balanceOf", LUMAN.getAddress());
            actual = kip7.decodeFunctionCall(encoded);
            checkTypeAndValue(expected, actual);

            expected = Arrays.asList(BRANDON.getAddress(), BigInteger.valueOf(10));
            encoded = kip7.encodeABI("transfer", BRANDON.getAddress(), BigInteger.valueOf(10));
            actual = kip7.decodeFunctionCall(encoded);
            checkTypeAndValue(expected, actual);

            expected = Arrays.asList(LUMAN.getAddress());
            encoded = kip7.encodeABI("isMinter", LUMAN.getAddress());
            actual = kip7.decodeFunctionCall(encoded);
            checkTypeAndValue(expected, actual);
        }
    }
