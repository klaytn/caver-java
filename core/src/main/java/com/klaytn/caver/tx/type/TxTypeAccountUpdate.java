...
public class TxTypeAccountUpdate extends AbstractTxType {
    ...
    public TxTypeAccountUpdate(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String from, AccountKey accountKey) {
        super(nonce, gasPrice, gasLimit, from, "", BigInteger.ZERO);
        this.accountKey = accountKey;
    }

    public static TxTypeAccountUpdate createTransaction(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String from, AccountKey accountKey) {
        return new TxTypeAccountUpdate(nonce, gasPrice, gasLimit, from, accountKey);
    }
