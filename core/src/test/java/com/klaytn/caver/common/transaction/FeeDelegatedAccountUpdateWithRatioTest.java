...
public class FeeDelegatedAccountUpdateWithRatioTest {
    ...
    public static class createInstanceBuilder {
        ...
        public void BuilderTest() {
            txObj = builder.build();
            assertNotNull(txObj);
            assertEquals(TransactionType.TxTypeFeeDelegatedAccountUpdateWithRatio.toString(), txObj.getType());
        }
    ...
    public static class createInstance {
        ...
        public void createInstance() {
            FeeDelegatedAccountUpdateWithRatio txObj = caver.transaction.feeDelegatedAccountUpdateWithRatio.create(
                    TxPropertyBuilder.feeDelegatedAccountUpdateWithRatio()
                            .setFrom(from)
                            .setNonce(nonce)
                            .setGas(gas)
                            .setGasPrice(gasPrice)
    ...
    public static class signAsFeePayer_OneKeyTest {
        ...
        public void before() {
            ...
            txObj = caver.transaction.feeDelegatedAccountUpdateWithRatio.create(
                    TxPropertyBuilder.feeDelegatedAccountUpdateWithRatio()
                            .setNonce(nonce)
                            .setGas(gas)
                            .setGasPrice(gasPrice)
    ...
    public static class signAsFeePayer_AllKeyTest {
        ...
        public void before() {
            ...
            mTxObj = caver.transaction.feeDelegatedAccountUpdateWithRatio.create(
                    TxPropertyBuilder.feeDelegatedAccountUpdateWithRatio()
                            .setNonce(nonce)
                            .setGas(gas)
                            .setGasPrice(gasPrice)
    ...
    public static class combineSignatureTest {
        ...
        public void combineSignatures() {
            ...
            String rlpEncoded = "";
    ...
    public static class recoverPublicKeyTest {
        ...
        FeeDelegatedAccountUpdateWithRatio tx = new FeeDelegatedAccountUpdateWithRatio.Builder()
                ...
                .setNonce("0x0")
                .setGas("0x2faf080")
                .setAccount(Account.createWithAccountKeyLegacy("0x07a9a76ef778676c3bd2b334edcf581db31a85e5"))
