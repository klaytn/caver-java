...
public class KeyringContainerTest {
    ...
    // SUI is a abbreviation which means "SDK Usability Improvement"
    // Below test cases is added for testing SUI patch is well working or not
    public static class generateTestSUI {
        Caver caver = new Caver(Caver.DEFAULT_URL);

        public void checkAddress(List<String> expectedAddress) {
            expectedAddress.forEach(address -> {
    ...
    public static class newKeyringTestSUI {
        Caver caver = new Caver(Caver.DEFAULT_URL);
    ...
    public static class updateKeyringTestSUI {
        @Rule
        public ExpectedException expectedException = ExpectedException.none();
    ...
    public static class getKeyringTestSUI {
        @Rule
        public ExpectedException expectedException = ExpectedException.none();
        ...
        public void upperCaseAddress() {
            String address = "0x37223E5E41186A782E4A1F709829F521F43B18E5";
            SingleKeyring keyring = caver.wallet.keyring.create(address, caver.wallet.keyring.generate().getKey().getPrivateKey());
    ...
    public static class addTestSUI {
        Caver caver = new Caver(Caver.DEFAULT_URL);
    ...
    public static class removeTestSUI {
        Caver caver = new Caver(Caver.DEFAULT_URL);
        ...
        public void multipleKey() {
            ...
            AbstractKeyring keyringToAdd = caver.wallet.keyring.createWithMultipleKey(address, expectPrivateKeyArr);
        ...
        public void roleBasedKey() {
            ...
            AbstractKeyring keyringToAdd = caver.wallet.keyring.createWithRoleBasedKey(address, Arrays.asList(expectPrivateKeyArr));
    ...
    public static class signMessageTestSUI {
        Caver caver = new Caver(Caver.DEFAULT_URL);
    ...
    public static class signTestSUI {
        @Rule
        public ExpectedException expectedException = ExpectedException.none();
        ...
        public void sign_withIndex_roleBasedKeyring() throws IOException {
            String address = caver.wallet.keyring.generate().getAddress();
            List<String[]> roleBasedKey = caver.wallet.keyring.generateRoleBasedKeys(new int[]{4, 5, 6}, "entropy");
        ...
        public void sign_customHasher() throws IOException {
            ...
            caver.wallet.sign(
                    keyring.getAddress(),
                    valueTransfer,
                    (AbstractTransaction tx) -> "0xd4aab6590bdb708d1d3eafe95a967dafcd2d7cde197e512f3f0b8158e7b65fd1"
            );
    ...
    public static class signAsFeePayerTestSUI {
        @Rule
        public ExpectedException expectedException = ExpectedException.none();
        ...
        public void signAsFeePayer_customHasher() throws IOException {
            ...
            caver.wallet.signAsFeePayer(
                    keyring.getAddress(),
                    valueTransfer,
                    (AbstractFeeDelegatedTransaction tx) -> "0xd4aab6590bdb708d1d3eafe95a967dafcd2d7cde197e512f3f0b8158e7b65fd1"
            );
