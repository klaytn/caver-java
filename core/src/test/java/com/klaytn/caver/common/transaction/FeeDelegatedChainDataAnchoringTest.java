...
public class FeeDelegatedChainDataAnchoringTest {
    ...
    public static class createInstance {
        ...
        public void createInstance() {
            FeeDelegatedChainDataAnchoring txObj = new FeeDelegatedChainDataAnchoring(
                    null,
                    from,
                    nonce,
                    gas,
    ...
    public static class signAsFeePayer_OneKeyTest {
        ...
        @Before
        public void before() {
            feePayerPrivateKey = PrivateKey.generate().getPrivateKey();
            keyring = KeyringFactory.createFromPrivateKey(feePayerPrivateKey);
            klaytnWalletKey = keyring.getKlaytnWalletKey();
            feePayerAddress = keyring.getAddress();

            txObj = new FeeDelegatedChainDataAnchoring.Builder()
                    .setNonce(nonce)
                    .setGasPrice(gasPrice)
                    .setGas(gas)
                    .setFrom(from)
    ...
    public static class signAsFeePayer_AllKeyTest {
        ...
        @Before
        public void before() {
            mTxObj = new FeeDelegatedChainDataAnchoring.Builder()
                    .setNonce(nonce)
                    .setGasPrice(gasPrice)
                    .setGas(gas)
                    .setFrom(from)
